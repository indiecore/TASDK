...
namespace UnrealScript
{
	...
	{
	public:
		ADD_OBJECT(SoundNodeWave, KillSounds, 196)
		...
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(49739);
			byte params[32] = { NULL };
			*(int*)params = Switch;
		...
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(49746);
			byte params[20] = { NULL };
		...
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(49752);
			byte params[16] = { NULL };
