...
namespace UnrealScript
{
	...
	public:
		...
		{
		public:
			ADD_STRUCT(Object::Vector, Velocity, 40)
			ADD_STRUCT(Object::Vector, Direction, 28)
		...
		public:
			...
			ADD_STRUCT(Object::Vector, Normal, 56)
			ADD_STRUCT(float, ParticleTime, 52)
		};
		...
		public:
			...
			ADD_STRUCT(Object::Vector, Vector_Low, 32)
			ADD_STRUCT(Object::Vector, Vector, 20)
...
void*>, SkelMeshComponents, 532)
		...
		ADD_STRUCT(Object::Vector, OldPosition, 572)
		ADD_STRUCT(Object::Vector, PartSysVelocity, 584)
...
void**)&params[0] = PSystem;
		...
		void SetBeamSourcePoint(int EmitterIndex, Object::Vector NewSourcePoint, int SourceIndex)
		{
			...
			byte params[20] = { NULL };
			*(int*)&params[0] = EmitterIndex;
			*(Object::Vector*)&params[4] = NewSourcePoint;
			*(int*)&params[16] = SourceIndex;
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
		}
		void SetBeamSourceTangent(int EmitterIndex, Object::Vector NewTangentPoint, int SourceIndex)
		{
			...
			byte params[20] = { NULL };
			*(int*)&params[0] = EmitterIndex;
			*(Object::Vector*)&params[4] = NewTangentPoint;
			*(int*)&params[16] = SourceIndex;
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
		}
		...
		void SetBeamTargetPoint(int EmitterIndex, Object::Vector NewTargetPoint, int TargetIndex)
		{
			...
			byte params[20] = { NULL };
			*(int*)&params[0] = EmitterIndex;
			*(Object::Vector*)&params[4] = NewTargetPoint;
			*(int*)&params[16] = TargetIndex;
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
		}
		void SetBeamTargetTangent(int EmitterIndex, Object::Vector NewTangentPoint, int TargetIndex)
		{
		...
		int DetermineLODLevelForLocation(Object::Vector& EffectLocation)
		{
			...
			byte params[16] = { NULL };
			*(Object::Vector*)&params[0] = EffectLocation;
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
			EffectLocation = *(Object::Vector*)&params[0];
		...
		void SetVectorRandParameter(ScriptName ParameterName, Object::Vector& Param, Object::Vector& ParamLow)
		{
			...
			*(ScriptName*)&params[0] = ParameterName;
			*(Object::Vector*)&params[8] = Param;
			*(Object::Vector*)&params[20] = ParamLow;
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
			Param = *(Object::Vector*)&params[8];
			ParamLow = *(Object::Vector*)&params[20];
		}
		...
		bool GetVectorParameter(ScriptName InName, Object::Vector& OutVector)
		{
			...
			byte params[24] = { NULL };
			*(ScriptName*)&params[0] = InName;
			*(Object::Vector*)&params[8] = OutVector;
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
			OutVector = *(Object::Vector*)&params[8];
