...
namespace UnrealScript
{
	...
	public:
		...
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(113229);
			byte params[32] = { NULL };
			*(int*)params = Switch;
		...
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(113236);
			byte params[20] = { NULL };
