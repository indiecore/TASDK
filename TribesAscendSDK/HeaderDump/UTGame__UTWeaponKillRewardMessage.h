...
{ \
	static ScriptProperty *script_property = ScriptObject::Find< ScriptProperty >( "StructProperty UTGame.UTWeaponKillRewardMessage." #y ); \
	return ( ##x( this, script_property->offset, z ) ); \
}
...
namespace UnrealScript
{
	...
	public:
			...
			{
				static ScriptFunction *function = ScriptObject::Find< ScriptFunction >( "Function UTGame.UTWeaponKillRewardMessage.GetString" );
			...
			{
				static ScriptFunction *function = ScriptObject::Find< ScriptFunction >( "Function UTGame.UTWeaponKillRewardMessage.ClientReceive" );
				byte *params = ( byte* )( malloc( 20 ) );
			...
			{
				static ScriptFunction *function = ScriptObject::Find< ScriptFunction >( "Function UTGame.UTWeaponKillRewardMessage.AnnouncementSound" );
