...
namespace UnrealScript
{
	...
	public:
		...
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(95370);
			byte params[32] = { NULL };
			*(int*)params = Switch;
		...
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(95377);
			byte params[20] = { NULL };
