...
namespace UnrealScript
{
	...
	{
	public:
		ADD_STRUCT(ScriptString*, MatchAboutToStart, 100)
		...
		{
			static ScriptFunction* function = ScriptObject::Find<ScriptFunction>("Function TribesGame.TrGameStartMessage.GetString");
			byte params[32] = { NULL };
			*(int*)&params[0] = Switch;
		...
		{
			static ScriptFunction* function = ScriptObject::Find<ScriptFunction>("Function TribesGame.TrGameStartMessage.ClientReceive");
			byte params[20] = { NULL };
