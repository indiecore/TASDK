...
namespace UnrealScript
{
	...
	public:
		...
		ADD_OBJECT(SoundCue, m_sFlagReturnedToStand, 208)
		ADD_OBJECT(SoundCue, m_sYouPickedUpFlag, 204)
		ADD_OBJECT(SoundCue, m_sOtherIsNewLeadeCue, 200)
		ADD_OBJECT(SoundCue, m_sYouAreNewLeadeCue, 196)
		ADD_STRUCT(ScriptString*, GetToTheFlag, 184)
		ADD_STRUCT(ScriptString*, KillTheRabbit, 172)
		ADD_STRUCT(ScriptString*, OtherDroppedFlag, 160)
		ADD_STRUCT(ScriptString*, YouDroppedFlag, 148)
		ADD_STRUCT(ScriptString*, OtherIsNewLeader, 136)
		ADD_STRUCT(ScriptString*, YouAreNewLeader, 124)
		ADD_STRUCT(ScriptString*, OtherScoreFlagTouch, 112)
		ADD_STRUCT(ScriptString*, YouScoreFlagTouch, 100)
		...
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(110330);
			byte params[32] = { NULL };
			*(int*)params = Switch;
		...
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(110338);
			byte params[20] = { NULL };
		...
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(110346);
			byte params[2] = { NULL };
			*params = MessageIndex;
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
			return params[1];
