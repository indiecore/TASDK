...
namespace UnrealScript
{
	...
	public:
		...
		ADD_STRUCT(Object::Rotator, m_TargetRotation, 268)
		...
		ADD_STRUCT(Object::Vector, m_vAxis, 240)
		...
		void SpinToTargetRotation(Object::Rotator TargetRotation, float Time, bool bReset)
		{
			...
			byte params[20] = { NULL };
			*(Object::Rotator*)&params[0] = TargetRotation;
