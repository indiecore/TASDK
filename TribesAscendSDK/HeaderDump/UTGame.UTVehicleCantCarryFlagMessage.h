...
namespace UnrealScript
{
	...
	public:
		...
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(49647);
			byte params[20] = { NULL };
		...
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(49653);
			byte params[16] = { NULL };
		...
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(49658);
			byte params[2] = { NULL };
			*params = MessageIndex;
			((ScriptObject*)this)->ProcessEvent(function, &params, NULL);
			return params[1];
		...
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(49661);
			byte params[32] = { NULL };
			*(int*)params = Switch;
