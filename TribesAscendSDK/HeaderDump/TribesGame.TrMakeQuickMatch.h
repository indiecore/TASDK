...
namespace UnrealScript
{
	...
	public:
		...
		ADD_BOOL(bProcessingJoin, 88, 0x2)
		ADD_BOOL(bIssuedInitialQuery, 88, 0x1)
		ADD_OBJECT(TrGameSettingsCommon, GameSettings, 84)
		ADD_OBJECT(TrGameSearchCommon, SearchSettings, 80)
		ADD_OBJECT(OnlineSubsystem, OnlineSub, 68)
		ADD_STRUCT(float, SearchStarted, 64)
