...
namespace UnrealScript
{
	...
	public:
		...
		ADD_STRUCT(Vector, ColorOverLife, 148)
		ADD_STRUCT(float, StartVelocityRadialMax, 144)
		ADD_STRUCT(float, StartVelocityRadialMin, 140)
		ADD_STRUCT(Vector, StartVelocityMax, 128)
		ADD_STRUCT(Vector, StartVelocityMin, 116)
		ADD_STRUCT(Vector, StartSizeMax, 104)
		ADD_STRUCT(Vector, StartSizeMin, 92)
