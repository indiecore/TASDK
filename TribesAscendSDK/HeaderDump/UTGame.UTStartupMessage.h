...
namespace UnrealScript
{
	...
	public:
		...
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(49390);
			byte params[20] = { NULL };
		...
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(49398);
			byte params[32] = { NULL };
			*(int*)params = Switch;
