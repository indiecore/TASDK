...
{ \
	static ScriptProperty *script_property = ScriptObject::Find< ScriptProperty >( "StructProperty TribesGame.TrExplosiveSpreeMessage." #y ); \
	return ( ##x( this, script_property->offset, z ) ); \
}
...
namespace UnrealScript
{
	...
	public:
			...
			{
				static ScriptFunction *function = ScriptObject::Find< ScriptFunction >( "Function TribesGame.TrExplosiveSpreeMessage.GetFontSize" );
			...
			{
				static ScriptFunction *function = ScriptObject::Find< ScriptFunction >( "Function TribesGame.TrExplosiveSpreeMessage.GetString" );
			...
			{
				static ScriptFunction *function = ScriptObject::Find< ScriptFunction >( "Function TribesGame.TrExplosiveSpreeMessage.ClientReceive" );
				byte *params = ( byte* )( malloc( 20 ) );
			...
			{
				static ScriptFunction *function = ScriptObject::Find< ScriptFunction >( "Function TribesGame.TrExplosiveSpreeMessage.AnnouncementSound" );
