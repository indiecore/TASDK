...
namespace UnrealScript
{
	...
	public:
		...
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(47503);
			byte params[32] = { NULL };
			*(int*)params = Switch;
		...
		{
			static ScriptFunction* function = (ScriptFunction*)(*ScriptObject::object_array())(47510);
			byte params[20] = { NULL };
