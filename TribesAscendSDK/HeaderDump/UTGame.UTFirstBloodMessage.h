...
namespace UnrealScript
{
	...
	{
	public:
		ADD_STRUCT(ScriptString*, FirstBloodString, 100)
		...
		{
			static ScriptFunction* function = ScriptObject::Find<ScriptFunction>("Function UTGame.UTFirstBloodMessage.GetString");
			byte params[32] = { NULL };
			*(int*)&params[0] = Switch;
		...
		{
			static ScriptFunction* function = ScriptObject::Find<ScriptFunction>("Function UTGame.UTFirstBloodMessage.ClientReceive");
			byte params[20] = { NULL };
