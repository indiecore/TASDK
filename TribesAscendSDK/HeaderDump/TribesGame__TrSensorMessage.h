...
{ \
	static ScriptProperty *script_property = ScriptObject::Find< ScriptProperty >( "StructProperty TribesGame.TrSensorMessage." #y ); \
	return ( ##x( this, script_property->offset, z ) ); \
}
...
namespace UnrealScript
{
	...
	public:
			...
			{
				static ScriptFunction *function = ScriptObject::Find< ScriptFunction >( "Function TribesGame.TrSensorMessage.GetString" );
			...
			{
				static ScriptFunction *function = ScriptObject::Find< ScriptFunction >( "Function TribesGame.TrSensorMessage.ClientReceive" );
				byte *params = ( byte* )( malloc( 20 ) );
