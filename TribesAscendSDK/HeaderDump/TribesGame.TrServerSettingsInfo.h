...
namespace UnrealScript
{
	...
	public:
		...
		ADD_BOOL(bObjectiveUpgrades, 524, 0x4)
		ADD_BOOL(bPreplacedObjectives, 524, 0x20)
		ADD_BOOL(bFriendlyFireDeployables, 524, 0x100)
		ADD_BOOL(bPoweredDeployables, 524, 0x8)
		ADD_BOOL(bFriendlyFireBaseAssets, 524, 0x80)
		ADD_STRUCT(int, BaseDestructionLimit, 508)
		ADD_STRUCT(int, MaxSpeedWithFlagLight, 692)
		ADD_STRUCT(int, MaxSpeedWithFlagMedium, 684)
		ADD_STRUCT(int, MaxSpeedWithFlagHeavy, 696)
		ADD_STRUCT(int, DecelerationRateWithFlag, 688)
		ADD_BOOL(bSupplyDropAmmoOnly, 524, 0x200)
		ADD_STRUCT(float, fEnergyMultiplier, 672)
		ADD_BOOL(bTeamCredits, 524, 0x800)
		ADD_STRUCT(int, RespawnTime, 496)
		ADD_STRUCT(int, TeamAssignType, 504)
		ADD_STRUCT(int, VehiclePrices, 604)
		ADD_STRUCT(int, FFKillLimit, 512)
		ADD_STRUCT(int, FFDamageLimit, 516)
		ADD_STRUCT(int, CallinPrices, 628)
		ADD_STRUCT(float, CallinBuildups, 652)
		ADD_STRUCT(int, CallinCooldowns, 640)
		ADD_STRUCT(int, TimeLimit, 476)
		ADD_STRUCT(int, OvertimeLimit, 500)
		ADD_STRUCT(int, WarmupTime, 480)
		ADD_BOOL(bAutoBalanceInGame, 524, 0x2)
		ADD_STRUCT(float, fFriendlyFireDamageMultiplier, 664)
		ADD_STRUCT(int, ArenaRounds, 492)
		ADD_STRUCT(int, GameScores, 528)
		ADD_BOOL(bCTFBlitzAllFlagsMove, 524, 0x2000)
		ADD_BOOL(bFriendlyFire, 524, 0x1)
		ADD_BOOL(bPoweredCallins, 524, 0x400)
		ADD_BOOL(bSkiEnabled, 524, 0x1000)
		ADD_STRUCT(int, SpawnType, 520)
		ADD_BOOL(bGeneratorAutoRegen, 524, 0x10)
		ADD_BOOL(bGenDestroyable, 524, 0x40)
		ADD_STRUCT(float, fAoEDamageMultiplier, 680)
		ADD_STRUCT(float, fAoESizeMultiplier, 676)
		ADD_STRUCT(float, fVehicleHealthMultiplier, 668)
		ADD_STRUCT(int, CallinsDenied, 624)
		ADD_STRUCT(int, VehicleLimits, 584)
