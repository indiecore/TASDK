...
namespace UnrealScript
{
	...
	{
	public:
		ADD_STRUCT(ScriptString*, EndSpreeNoteTrailer, 316)
		ADD_OBJECT(SoundNodeWave, SpreeSound, 292)
		ADD_STRUCT(ScriptString*, SelfSpreeNote, 220)
		ADD_STRUCT(ScriptString*, SpreeNote, 148)
		ADD_STRUCT(ScriptString*, MultiKillString, 136)
		ADD_STRUCT(ScriptString*, EndFemaleSpree, 124)
